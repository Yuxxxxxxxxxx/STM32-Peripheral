...
#ifdef RS485
/* RS485芯片发送使能GPIO, PB2 */
/* 用作板载 RS485 芯片的使能，本例未用到 */
//#define RCC_RS485_TXEN 	 RCC_AHB1Periph_GPIOB
//#define PORT_RS485_TXEN  UART3_TX_PORT
//#define PIN_RS485_TXEN	 UART3_TX_PIN

//#define RS485_RX_EN()	{ GPIO_WriteBit(PORT_RS485_TXEN, PIN_RS485_TXEN, Bit_RESET); } //PORT_RS485_TXEN->BSRRH = PIN_RS485_TXEN
//#define RS485_TX_EN()	{ GPIO_WriteBit(PORT_RS485_TXEN, PIN_RS485_TXEN, Bit_SET); } //PORT_RS485_TXEN->BSRRL = PIN_RS485_TXEN
#endif
