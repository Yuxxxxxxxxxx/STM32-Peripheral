...
static struct {
  ...
  volatile unsigned long bus_fault_address;
  volatile unsigned long memmanage_fault_address;
} HardFaultRegs;
#endif
...
void HardFaultHandler(unsigned int* pStack) {
  ...
  */
  HardFaultRegs.bus_fault_address       = SCB->BFAR;  // BusFault Address Register
  HardFaultRegs.memmanage_fault_address = SCB->MMFAR; // MemManage Fault Address Register
  HardFaultRegs.cfsr                    = SCB->CFSR;  // BusFault Address Register
